网易云信 IM UIKit 是基于 [网易云信 IM SDK（NIM SDK）](https://doc.yunxin.163.com/messaging2/concept/DI0Nzc2NzA?platform=client) 开发的 [即时通讯 UI 组件库](https://doc.yunxin.163.com/messaging-uikit/concept/TI3NTgyNDA?platform=client)，功能涵盖聊天、会话、群管理等核心场景。

本文介绍如何在微信小程序中集成 IM UIKit。
...
![微信原生小程序UIKit界面](https://yx-web-nosdn.netease.im/common/371fa889a01662bf4ab42e33d15e1a75/微信原生小程序UIKit界面.png)

IM UIKit 主要包含以下 UI 模块：
...
![云信后台创建应用](https://yx-web-nosdn.netease.im/common/35aee1ff4f6ca74da11929c9fe9ee960/云信后台创建应用.png)

> **提示**：请妥善保管 AppKey，后续配置时需要使用。
...
![创建小程序](https://yx-web-nosdn.netease.im/common/ee5a4187eaeb1a73c05817a11ed69e7f/创建小程序.png)
...
下载 [NEUIKit_MiniApp.zip](https://yx-web-nosdn.netease.im/common/0798c8a663b7063d922e5549c612d9b8/NEUIKit_MiniApp.zip)，解压后将 **NEUIKit** 文件夹复制到项目的 `miniprogram/components` 目录下。
...
![小程序UIKit目录结构](https://yx-web-nosdn.netease.im/common/c6a41ea02281b2e8d991ec9d11c4d26d/小程序UIKit目录结构.png)
...
| 参数 | 说明 | 获取方式 |
|-----|------|---------|
| `APP_KEY` | 云信应用的唯一标识 | 从 [云信控制台](https://app.yunxin.163.com/) 获取 |
...
> ⚠️ **安全提示**：如果您在调试环境中使用的是网易云信控制台生成的测试用 IM 账号和 Token，请确保在后续的正式生产环境中，将其替换为通过 [IM 服务端 API](https://doc.yunxin.163.com/messaging2/server-apis) 生成的正式 IM 账号（accid）和 Token，以保障通信安全。
...
![微信开发者工具项目配置](https://yx-web-nosdn.netease.im/common/c44ec402c805bf708033834d089d5661/微信开发者工具项目配置.png)

### 2. 发送第一条消息

登录成功后，您可以尝试发送第一条消息：

![发送您的第一条消息](https://yx-web-nosdn.netease.im/common/b80721fb50afbb5eb35ec2acec034860/发送您的第一条消息.png)
