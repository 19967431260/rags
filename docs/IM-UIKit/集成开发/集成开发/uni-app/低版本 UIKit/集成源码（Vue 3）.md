...
IM uni-app Demo 是基于网易云信 IM UIKit（NEUIKit）的一款 uni-app Demo，托管在 GitHub 开源代码仓库 [nim-uikit-uniapp](https://github.com/netease-kit/nim-uikit-uniapp)。该 Demo 提供了一些通用的功能，包含会话、聊天、群组等，您可以基于源码搭建您的即时通讯业务逻辑。本文描述适用于 Vue.js 3.x 版本项目。
...
```Bash
# 找一个目录，clone 组件项目，使用 V9 需要将分支切至 1.5.0 版本
...
<img src="https://yx-web-nosdn.netease.im/common/6d4298d192026594bc29795d704ee996/目录结构.png" style="width:50%;border: 1px solid #BFBFBF;">
...
在您的项目 `App.vue` 文件中引入 NEUIKit 组件并进行初始化。
...
如果您需要自行实现目前 uni-app UIKit 还未实现，但原生的 [IM uni-app SDK](https://doc.yunxin.163.com/messaging/guide/zE4NDUwOTU?platform=uniapp) 已提供的能力。您可以通过调用原生 IM uni-app SDK 中提供的接口来实现。原生 uni-app SDK 中的 API，请参考 [NIM Web SDK](https://doc.yunxin.163.com/messaging/references/web/typedoc/Latest/zh/NIM/index.html)。
