...
根据本文操作前，请确保您已经完成 [IM UIKit 初始化](https://doc.yunxin.163.com/messaging-uikit/guide/zIzOTk1MDI?platform=h5#第三步集成并初始化组件)。
...
在 **NEUIKit** 的 **/NEUIKit/Chat/message/message-item.vue** 下，添加自定义消息渲染的代码。
