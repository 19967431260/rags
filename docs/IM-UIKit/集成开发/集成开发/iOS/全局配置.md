...
除了功能开关配置外，NIM UIKit 还提供了一些常用的全局设置。建议您使用 [`SettingRepo.shared`](https://doc.yunxin.163.com/messaging-uikit/client-apis/DQ3MzY5OTc?platform=iOS) 进行设置，以下是两个典型示例：
...
<img style="width:30%" src="https://yx-web-nosdn.netease.im/common/8106e3b9a381b1194e167679270b26fa/已读未读状态.png"/>
...
有关这些配置的详细使用方法，请参考 [`SettingRepo`](https://doc.yunxin.163.com/messaging-uikit/client-apis/DQ3MzY5OTc?platform=iOS) 的相关文档。