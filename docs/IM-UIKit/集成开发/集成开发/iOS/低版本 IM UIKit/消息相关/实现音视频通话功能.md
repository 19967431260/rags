...
- 已开通 IM 即时通讯、音视频通话 2.0、音视频通话2.0-话单以及信令能力。开通服务的操作流程请参考 [开通能力](https://doc.yunxin.163.com/nertccallkit/docs/DIzMzA0Nzk?platform=iOS)。
...
parameters 参数|类型|说明
:----|:----|
`remoteUserAccid` |String|被呼叫方的用户账号（accid）
`currentUserAccid`|String|呼叫方的用户账号（accid）
...
呼叫组件相关错误码，请参见[错误码](https://doc.yunxin.163.com/nertccallkit/docs/TQ5NDE0NDE?platform=iOS)。
...
更多问题，请参见[呼叫组件常见问题](https://doc.yunxin.163.com/nertccallkit/docs/TIzNjUwODg?platform=iOS)。
