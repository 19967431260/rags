...
- 自 V10.8.0 版本，网易云信支持 AI 数字人 **流式输出** 能力，通过实时分片传输 AI 生成的内容，降低响应延迟、支持中断控制，显著改善用户交互体验。
:::
...
- 在会话聊天中，支持 AI 划词搜索功能。详情请参考 [实现划词搜索](https://doc.yunxin.163.com/aiagents/guide/TIxODQyNzE?platform=client)。
- 在会话聊天中，支持 AI 翻译功能。详情请参考 [实现多国语言翻译](https://doc.yunxin.163.com/aiagents/guide/Dc5NzMwMTY?platform=client)。
...
<div class="container">
  <div class="column">
    <figure>
      <figcaption>AI 划词搜索</figcaption> 
      <img alt="WebAI划词搜索.png" src="https://yx-web-nosdn.netease.im/common/222ee987448b363fef6595c35966df32/WebAI划词搜索.png"> 
    </figure>
  </div>
  <div class="column">
    <figure>
      <figcaption>AI 语言翻译</figcaption> 
      <img alt="Web.png" src="https://yx-web-nosdn.netease.im/common/fb2f92a5fd2cd0e48f57df1c7bbd1753/Web.png"> 
    </figure>
  </div>
</div>
...
<div class="container">
  <div class="column">
    <figure>
      <figcaption>AI 流式输出</figcaption> 
      <img alt="AI流式输出.png" src="https://yx-web-nosdn.netease.im/common/62be8a69c8bf844e058cd08ff763506a/AI流式输出.png"> 
    </figure>
  </div>
  <div class="column">
    <figure>
      <figcaption>AI 流式重新输出</figcaption> 
      <img alt="AI重新输出.png" src="https://yx-web-nosdn.netease.im/common/7a7bca0a6a883268c0dd16fc31d51bbf/AI重新输出.png"> 
    </figure>
  </div>
</div>
...
在登录成功之后，您需要根据网易云信控制台配置的 AI 数字人进行筛选，并确定负责 AI 翻译或者 AI 划词的数字人。然后在接口方法中，将网易云信控制台上配置的 AI 数字人作为入参，如下所示。
...
```TypeScript
const localOptions = { aiVisible: false }
```

## AI 数字人流式输出开关

IM UIKit 提供全局功能开关，用来控制是否使用 AI 数字人流式输出功能。一旦您将功能开关设置为 `false`，则所有跟 AI 数字人相关功能均不使用流式输出 AI 消息。

```TypeScript
const localOptions = { aiStream: false }
```