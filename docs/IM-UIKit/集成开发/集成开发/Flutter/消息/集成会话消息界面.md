<!--keywords: 会话消息界面,集成会话消息界面,UIKit,demo,IM UIKit,IMUIKit,Kit -->

本文介绍如何集成会话消息界面。 

::: note note
会话消息界面 UI 个性化定制相关说明，请参见 [自定义会话消息 UI](https://doc.yunxin.163.com/messaging-uikit/guide/DQyNjE5NDM?platform=flutter)。
:::
