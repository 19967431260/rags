...
- 会话列表界面自定义事件监听相关说明，请参见 [会话列表事件监听](https://doc.yunxin.163.com/messaging-uikit/guide/Dk1OTIwMTg?platform=flutter)。
:::
...
标题使用的是 `AppB` 系统组件，包含 `title` 与 `actions` 两块区域（图中的 left icon, right icon2，right icon1 为 `actions` 区域），如下图所示：
...
默认 | 自定义后
---- | ----
<img alt="conversation_01_resized.png" src="https://yx-web-nosdn.netease.im/common/bac81514a9e1944029a411e38bbd6b57/conversationtitledefaultnew.png" style="width:80%;border: 1px solid #BFBFBF;"> | <img alt="conversation_01_resized.png" src="https://yx-web-nosdn.netease.im/common/b9f7224c65ec1a68b44ccdc82c62cefa/conversationtitleconfig.png" style="width:80%;border: 1px solid #BFBFBF;">
...
默认 | 自定义后
---- | ----
<img alt="conversation_01_resized.png" src="https://yx-web-nosdn.netease.im/common/5a42c14b0da0124ba61a78528cd5aa74/conversationListSource.png" style="width:80%;border: 1px solid #BFBFBF;"> | <img alt="conversation_01_resized.png" src="https://yx-web-nosdn.netease.im/common/48d4fdc4b7d383908b7f2585d67bf9d2/conversationItemConfig.png" style="width:80%;border: 1px solid #BFBFBF;">
...
默认 | 自定义后
---- | ----
<img alt="conversation_01_resized.png" src="https://yx-web-nosdn.netease.im/common/48d4fdc4b7d383908b7f2585d67bf9d2/conversationItemConfig.png" style="width:80%;border: 1px solid #BFBFBF;"> | <img alt="conversation_01_resized.png" src="https://yx-web-nosdn.netease.im/common/1574950f8efb4458c89fcc924af9f3c6/conversationsortnew.png" style="width:80%;border: 1px solid #BFBFBF;">
...
默认 | 自定义后
---- | ----
<img alt="conversation_01_resized.png" src="https://yx-web-nosdn.netease.im/common/5a42c14b0da0124ba61a78528cd5aa74/conversationListSource.png" style="width:80%;border: 1px solid #BFBFBF;"> | <img alt="conversation_01_resized.png" src="https://yx-web-nosdn.netease.im/common/9c5d8208416754f7a427e6c590b935c5/conversationitembuildernew.png" style="width:80%;border: 1px solid #BFBFBF;">