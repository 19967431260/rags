...
- 讯录界面自定义事件监听相关说明，请参见<a href="https://doc.yunxin.163.com/messaging-uikit/guide/jU2MDYxMDQ?platform=flutter" target="_blank">通讯录事件监听</a>。
:::
...
`topListItemBuilder` | TopListItemBuilder | 自定义相关功能模块组件构建，会替换掉默认的Item
`topEntranceClick` | TopEntranceClick |相关功能模块的点击
`contactItemBuilder` | ContactItemBuilder | 自定义通讯录好友组件构建，会替换掉默认的Item
`contactItemClick` | ContactItemClick | 通讯录好友的点击
`contactItemSelect` | ContactItemSelect | 通讯录好友的选择（通讯录列表 isCanSelectMemberItem 字段为true时有效，默认false）
...
:-------- | :---------- 
![列表默认.png](https://yx-web-nosdn.netease.im/common/67c12f6911731349ad0f1a9a937ad40f/列表默认.png) | ![列表配置.png](https://yx-web-nosdn.netease.im/common/766e55bc1e0a3c63536c6e8ad01c3897/列表配置.png)
