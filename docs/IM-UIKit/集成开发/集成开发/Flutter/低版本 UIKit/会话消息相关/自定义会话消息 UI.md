...
`messageClickListener` | MessageClickListener | 消息点击事件，详见<a href="https://doc.yunxin.163.com/messaging-uikit/guide/jMzNDg0NjA?platform=flutter" target="_blank">会话消息事件监听</a>
`getPushPayload` | Map<String, dynamic> Function(NIMMessage message) | 设置推送payload 的回调方法，会在消息发送前调用
`imagePlaceHolder` | Widget Function(double aspectRatio, {double? width})?  | 设置图片消息显示的预占位图
`maxVideoSize` | int | 视频消息最大size 单位M，不设置默认为200
`maxFileSize` | int | 文件消息最大size 单位M，不设置默认为200
...
::: note note
关于自定义消息的详细内容，请参见<a href="https://doc.yunxin.163.com/messaging-uikit/guide/zg5ODU0MTk?platform=flutter" target="_blank">实现自定义消息收发</a>。
:::
...
- 假设您需要标记消息背景色、已读未读状态等。
  ...
  - UI 效果
    ...
    :---- | :-------------- 
    ![被标记消息的背景色.PNG](https://yx-web-nosdn.netease.im/common/e8f5710e0f8fb7ff1b15677d709446ba/被标记消息的背景色.PNG) |   ![Flutter已读未读状态.png](https://yx-web-nosdn.netease.im/common/fc1e9ba530605e407b15324e200b6c18/Flutter已读未读状态.png)
...
- 假设您需要修改消息背景色，头像圆角，消息字体，时间字体等。
  ...
  - UI 效果
    ...
    :---- | :-------------- 
    ![消息默认.jpg](https://yx-web-nosdn.netease.im/common/9bea758f4f6dd6f957c1fb14ea8c1e79/消息默认.jpg) | ![消息自定义.png](https://yx-web-nosdn.netease.im/common/1e29a1b83eb50669a3c2079cb8c89b04/消息自定义.png)
...
- UI 效果
  ...
  <div style="width:120px">默认样式</div> | <div style="width:120px">自定义样式</div>
  :---- | :-------------- 
  ![消息弹窗默认.png](https://yx-web-nosdn.netease.im/common/f1698fcd81d2e73d6e9add455cdca8b6/消息弹窗默认.png) | ![消息弹窗.png](https://yx-web-nosdn.netease.im/common/de7ba135b52b83cc3069496119f21309/消息弹窗.png)
...
通过配置`moreActions`来给更多面板添加自定义按钮，同时，如果您不需要展示原本的默认按钮，那可以将`keepDefaultMoreAction`设置为false。
...
<img style="width:60%" src="https://yx-web-nosdn.netease.im/common/63bd0964ac2a99be56fb64ea1099db4f/更多面板按钮.png"/>
