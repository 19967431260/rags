 ...
 *   ⽣产环境(线上环境)或开发环境(测试环境)，请选择与该证书⽣成时相同的环境类型。
  ...
  <img src="https://yx-web-nosdn.netease.im/quickhtml%2Fassets%2Fyunxin%2Fdefault%2FLark20200421-110355.png"  width="400"/>
  
  ::: note notice :::

  图中**证书密钥**是从钥匙串导出 p12 证书文件时，用户自行设置的密码，与设置的密码保持一致即可。
