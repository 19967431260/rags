...
| tags | NSArray<NSString> | 标签，可以设置多个，如果不传，则会删掉老的标签 |
| notifyTargetTags | NSString | 更新标签的通知的目标标签，是一个[标签表达式](#标签表达式)，同时也会改变该连接掉线时的通知对象，见TagCalculator和TagPattern，如果不传，则会删掉老的notifyTargetTags |
