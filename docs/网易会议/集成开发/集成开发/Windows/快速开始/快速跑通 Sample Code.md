...
1. 在 **Your AppKey** 处填入应用 AppKey，然后单击左侧 **初始化** 按钮完成初始化操作。
    ...
    ![Windows初始化.png](https://yx-web-nosdn.netease.im/common/811ab3b83860b0ccb17e2d1a01ae5e2d/Windows初始化.png)

2. 切换到账号页，填入 **账号** 和 **token**，单击 **token登入** 完成登录操作。

    ![Windows登录.png](https://yx-web-nosdn.netease.im/common/d536438e002c28a85e82834f642a6708/Windows登录.png)

3. 切换到会议页，左侧选择 **startMeeting**，单击 **Run** 运行，完成创建会议操作。
 
    ![Windows创建会议.png](https://yx-web-nosdn.netease.im/common/8e2db56a48e2f65cfaae63416a68f9f0/Windows创建会议.png)