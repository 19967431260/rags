...
- [OBS 官网](https://obsproject.com/download?spm=a2c4g.11186623.2.15.6aac1445JPlKR8)可以下载到适合您操作系统的版本，下载完成后，请按照引导进行安装。
...
::: note note
码率越大，视频的画面越清晰，但同时对带宽的要求也越高。<br/>因此，需要根据自己的网络和设备适当调整分辨率和码率
:::
...
::: note note
分辨率越大，视频画面尺寸越大，若此时码率不变，则视频的画面会变差。<br/>因此，分辨率越大，码率也要设置越大
:::
...
![10](https://yx-web-nosdn.netease.im/quickhtml/assets/yunxin/default/obs_gop.png)
...
::: note note
多声道声音效果越好，但是如果播放器不支持，则无法正常播放。<br/>
