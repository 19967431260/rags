...
### <span id="SDK下载地址">SDK下载地址</span>

[php sdk 的下载地址](https://github.com/vcloud163/php-sdk "php sdk 的下载地址")
...
### <span id="安装composer">安装composer</span>
...
#### <span id="composer.json">composer.json</span>
...
接入网易云信视频点播，需要拥有一对有效的 appKey 和 appSecret进行签名认证，可通过如下步骤获得：
...
- $opt["accessKey"]：AppKey
- $opt["secretKey"]：AppSecret
- $opt["trunkSize"]：分片大小，最大4MB
