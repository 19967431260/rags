...
```
GET https://{endpoint}/im/v2.1/conversations/{conversation_id}
```
...
参数名称 | 类型 | 是否必选 | 说明 | 示例 |
---- | ---- | ---- | ---- | ---- |
`conversation_id` | String | 是 | 需要查询的会话 ID，若传入的会话 ID 不存在会返回 414 错误码。 | 单聊会话：`account_id1|1|account_id2`<br>高级群会话：`account_id1|2|team_id`<br>超大群会话：`account_id1|3|team_id`
...
```JSON
{
  ...
  "data": {
    ...
    "sender_id": "qaz",
    "receiver_id": "qaz1",
    "server_extension": "server_extension-obdvd",
    "group_ids": [],
    "last_message": {
    ...
    "unread_count": 1,
    "stick_top": false,
    "sort_order": 1753262877657,
    "create_time": 1753262876364,
    "update_time": 1753262877776,
    "last_read_time": 1753262704802
  }
}
```
