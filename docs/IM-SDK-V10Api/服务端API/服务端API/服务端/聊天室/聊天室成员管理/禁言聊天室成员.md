...
```
PATCH https://{endpoint}/im/v2/room_members/{account_id}/actions/chat_banned
```
...
参数名称 | 类型 | 是否必选 | 描述
---- | ---- | ---- | ----
`account_id` | String | 是 | 需要禁言或取消禁言的成员账号 ID。
...
| 114405 | 聊天室成员重复操作 | chatroom member repeated operation
| 114429 | 聊天室成员操作列表包含操作者 | operator in chatroom member operation list
