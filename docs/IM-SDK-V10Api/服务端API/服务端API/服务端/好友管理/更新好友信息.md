<!--keywords: 更新好友,修改好友信息,好友信息,好友关系,好友管理 -->
...
```
PATCH https://{endpoint}/im/v2.1/friends/{account_id}
```
...
参数名称 | 类型 | 是否必选 | 描述
:---- | :---- | :---- | :----
`account_id` | String | 是 | 发起更新操作的账号 ID。

### 请求体参数

参数名称 | 类型 | 是否必选 | 描述
:---- | :---- | :---- | :---- |
`friend_account_id` | String | 是 | 需要更新信息的好友账号 ID。 |
