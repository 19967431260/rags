...
```
DELETE https://{endpoint}/im/v2/mute_contacts/{account_id}
```
...
参数名称 | 类型 | 是否必选 | 描述
:---- | :---- | :---- | :----
`account_id` | String | 是 | 发起取消免打扰操作的 IM 账号 ID。

### 查询参数

参数名称 | 类型 | 是否必选 | 描述
:---- | :---- | :---- | :----
`contact_account_id` | String | 是 | 需要被取消免打扰的 IM 账号 ID。
